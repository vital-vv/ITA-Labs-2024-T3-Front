...
import {
  clearUserData,
  selectUserData,
} from '../../../features/currentUser/currentUserSlice.js';
    ...
    <div>
      ...
      >
        ...
        <NavLink
          ...
          onClick={handleClose}
          className={isAdmin ? styles.notDisplay : null}
        >
          <img src={advertisements} alt="advertisements" />
          My advertisments
        </NavLink>
        <NavLink
          to={ROUTES.BETS}
          onClick={handleClose}
          className={isUser ? null : styles.notDisplay}
        >
          <img src={bet} alt="betting" />
          Betting
        </NavLink>
        <NavLink
          to={ROUTES.ORDERS}
        ...
        <NavLink
          ...
          onClick={handleClose}
          className={isAdmin ? null : styles.notDisplay}
        >
        ...
        <NavLink to={ROUTES.ACCOUNT} onClick={handleClose}>
          <img src={account} alt="account" />
          My account
        </NavLink>
        <hr />
        <NavLink to={ROUTES.ACCOUNT} onClick={signOutApp}>
