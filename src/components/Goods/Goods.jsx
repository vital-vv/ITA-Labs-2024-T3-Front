    ...
    <>
      <div className={classes.goods}>
        <div className={classes.picture}>
          <img src={lotItem.image_url && lotItem.image_url[0] ? lotItem.image_url[0].url : "https://zm61.ru/upload/iblock/84b/srjklt20apje627nhctsvp8voy5oxppg.jpg"} alt="Photo of goods" />
        </div>
