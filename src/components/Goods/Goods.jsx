                ...
                <div className={classes.info}>
                    <div>
                        <div className={classes.labelOfGood}><p>{lotItem.title}</p>
                            {currentTabName.currentTab === 'Pending' &&
                                <ManageLot lotStatus={lotItem.status} lotId={lotItem.lot_id}/>}
                        </div>
                    ...
                    <div className={classes.more}>
                        <p className={classes.description}>
                            {`${lotItem.title}, ${lotItem.category_name}, ${lotItem.quantity} ton, ${lotItem.fromSize || lotItem.size}-${lotItem.toSize || lotItem.size} mm, ${lotItem.packaging}`}
                        </p>
